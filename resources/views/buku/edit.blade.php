        ...
        <div class="mt-4 p-3">
            <div class="col-md-12">
                ...
                <div class="card shadow rounded">
                    ...
                    <div class="card-body">
                        <form action="{{ route('buku.update',$buku->id_buku) }}" method="POST" class="row mx-3">
                            @csrf
                            @method('PUT')
                            <!--Input isbn-->
                            <div class="form-group mt-3 col-3">
                                ...
                                <input type="text" class="mt-1 form-control @error('isbn')is-invalid @enderror"
                                    ...
                                    placeholder="contoh: 9786020312552">
                            ...
                            <div class="form-group mt-3 col-6">
                                ...
                                <input type="text" class="mt-1 form-control @error('judul_buku') is-invalid @enderror"
                                    name="judul_buku" value="{{ old('judul_buku',$buku->judul_buku) }}" required>
                            ...
                            <div class="form-group  mt-3 col-3">
                                ...
                                <input type="text" class="mt-1 form-control @error('nama_penulis') is-invalid @enderror"
                                    name="nama_penulis" value="{{ old('nama_penulis',$buku->nama_penulis) }}" required>
                            ...
                            <div class="form-group mt-3 col-3">
                                ...
                                <select class="mt-1 form-select @error('kode_penerbit') is-invalid @enderror"
                                    ...
                                    @if(old('kode_penerbit',$buku->kode_penerbit)==$penerbit->kode_penerbit)
                            ...
                            <div class="form-group  mt-3 col-3">
                                ...
                                <input type="number" class="mt-1 form-control @error('jumlah') is-invalid @enderror"
                                    name="jumlah" value="{{ old('jumlah',$buku->jumlah) }}" required>
                            ...
                            <div class="form-group mt-3 col-3">
                                ...
                                <select class="mt-1 form-select @error('role') is-invalid @enderror"
                                    name="kode_kategori" id="kode_kategori" required>
                                    @foreach ($kategoris as $kategori)
                                    @if(old('kode_kategori',$buku->kode_kategori)==$kategori->kode_kategori)
                            ...
                            <div class="form-group mt-3 col-12">
                                ...
                                <input type="text" class="mt-1 form-control @error('deskripsi') is-invalid @enderror"
                                    name="deskripsi" value="{{ old('deskripsi',$buku->deskripsi) }}" required></input>
