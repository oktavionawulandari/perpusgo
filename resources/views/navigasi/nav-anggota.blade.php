<nav class="navbar fixed-top" style="background-color:#757BC8">
    <div class="container-fluid">
        ...
        <a class="nav-link active float-end text-light fs-5" aria-current="page" href="#">PerpusGo</a>
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body mt-2">
                <div class="text-center">
                    <a href="{{route('anggota.edit-profile')}}">
                        <i class="bi bi-person-circle" style="font-size:2rem;color:black"></i>
                    </a>
                    <div class="mt-1">
                        {{Auth::guard('anggota')->user()->nama_anggota}} <br>
                        - {{Auth::guard('anggota')->user()->role}} -
                    </div>
                </div>
                <hr>
                <div class="d-flex flex-column flex-shrink-1 p-2">
                    <div class="list-group">
                        ...
                        <a href="{{route('transaksi.anggota')}}"
                            class="navbar-brand list-group-item list-group-item-action border-0"><i
