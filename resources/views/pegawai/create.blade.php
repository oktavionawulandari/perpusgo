        ...
        <div class="container mt-4 p-3">
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow rounded">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pegawai.store') }}" method="POST" class="row mx-3">
                            @csrf
                            <!--Input nip-->
                            ...
                            <div class="form-group  mt-3 col-3">
                                ...
                                <input type="email" class="mt-1 form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ old('email') }}" placeholder="nama@gmail.com" required>
