        ...
        <div class="container mt-4 p-3">
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow rounded">
                    <div class="card-header p-3 fs-5 text-light" style="background-color: #757BC8;">Edit Profile
                    </div>
                    <div class="card-body">
                        <form action="{{ route('pegawai.updateprofile',$pegawai->id_pegawai) }}" method="POST"
                            class="row mx-3">
                            @csrf
                            @method('PUT')
                            <!--Input nip-->
                            <div class="form-group mt-3 col-4">
                                ...
                                <input type="text" class="mt-1 form-control @error('nip')is-invalid @enderror" id="nip"
                                    name="nip" value="{{ old('nip',$pegawai->nip) }}" readonly>
                            ...
                            <div class="form-group  mt-3 col-4">
                                ...
                                <input type="text" class="mt-1 form-control @error('username') is-invalid @enderror"
                                    name="username" value="{{ old('username',$pegawai->username) }}" required>
                            ...
                            <div class="form-group mt-3 col-4">
                                ...
                                <input type="text" class="mt-1 form-control @error('role')is-invalid @enderror" id="role"
                                    name="role" value="{{ old('role',$pegawai->role) }}" readonly>
                            ...
                            <div class="mt-5 mb-3">
                                <a href="{{route('pegawai.ubahpassword')}}" class="btn btn-md btn-danger text-light float-start">
                                    <i class="bi bi-shield-lock-fill"></i> Ubah Password</a>
                                <a href="{{ route('home.pegawai') }}" class="btn btn-md btn-outline float-end ms-2"
