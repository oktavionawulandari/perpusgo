        ...
        <div class="container mt-4 p-3">
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow rounded">
                    ...
                    <div class="card-body">
                        <form action="{{ route('anggota.updateprofile',$anggota->id_anggota) }}" method="POST"
                            class="row mx-3">
                            @csrf
                            @method('PUT')
                            <!--Input nim-->
                            ...
                            <div class="form-group  mt-3 col-3">
                                ...
                                <input type="text" class="mt-1 form-control @error('username') is-invalid @enderror"
                                    name="username" value="{{ old('username',$anggota->username) }}" required>
                            ...
                            <div class="form-group mt-3 col-3">
                                ...
                                <input type="text" class="mt-1 form-control @error('role')is-invalid @enderror" id="role"
                                    name="role" value="{{ old('role',$anggota->role) }}" readonly>
                            ...
                            <div class="mt-5 mb-3">
                                <a href="{{route('anggota.ubahpassword')}}" class="btn btn-md btn-danger text-light float-start">
                                    <i class="bi bi-shield-lock-fill"></i> Ubah Password</a>
                                <a href="{{ route('home.anggota') }}" class="btn btn-md btn-outline float-end ms-2"
